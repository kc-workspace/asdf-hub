...
KC_ASDF_NAME="asdf-hub"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-hub"
## Application information
KC_ASDF_APP_NAME="hub"
KC_ASDF_APP_DESC="a command-line tool that makes git easier to use with GitHub."
KC_ASDF_APP_REPO="https://github.com/github/hub"
## Download settings
KC_ASDF_DOWNLOAD_URL="https://github.com/github/hub/releases/download/v{version}/hub-{os}-{arch}-{version}.tgz"
KC_ASDF_DOWNLOAD_NAME="hub-{os}-{arch}-{version}.tgz"
KC_ASDF_CHECKSUM_URL=""
KC_ASDF_DOWNLOAD_LOC="hub"
